...
function CheckoutForm({disabled, stateData}){
    const cartReducer = useSelector((state)=>state.cartReducer)
    const { cart, checkout } = cartReducer    
                ...
                <div className="order-table table-responsive">
                    <table className="table table-bordered">
                        ...
                        <tbody>
                            {
                                checkout &&
                                checkout.products.map((data, idx)=>(
                                    <tr key={idx}>
                                        ...
                                        <td className="product-total">
                                            <span className="subtotal-amount">{data.price.formatted_with_symbol}</span>
                                        </td>
                                    </tr>
                                ))
                            }                            
                            <tr>
                                ...
                                <td className="order-subtotal-price">
                                    <span className="order-subtotal-amount">{checkout?.live?.subtotal?.formatted_with_symbol}</span>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td className="product-subtotal">
                                    <span className="subtotal-amount">{cart.subtotal.formatted_with_symbol}</span>
                                </td>
                            </tr>
                        </tbody>
                    </table>
